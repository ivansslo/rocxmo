...
import com.ivansslo.terminal.App.Companion.getTempDir
import com.ivansslo.terminal.BuildConfig
...
object MkSession {
    ...
    fun buildCustomPendingCommand(context: Context, custom: CustomSession): PendingCommand {
        ...
        return PendingCommand(
            shell = shell,
            args = args,
            workingDir = scriptFile.parentFile?.absolutePath ?: "/sdcard/rocxmo",
            env = null
        )
    }
