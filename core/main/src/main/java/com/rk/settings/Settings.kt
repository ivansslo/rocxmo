...
import com.ivansslo.terminal.ui.screens.settings.WorkingMode
import com.ivansslo.terminal.ui.screens.settings.InputMode
...
object Settings {
    ...
    var theme_palette: com.ivansslo.terminal.ui.theme.ThemePalette
        get() = com.ivansslo.terminal.ui.theme.ThemePalette.fromName(selected_palette)
    ...
    fun getShortcutBinding(action: com.ivansslo.terminal.ui.screens.terminal.ShortcutAction): com.ivansslo.terminal.ui.screens.terminal.ShortcutBinding {
        val raw = Preference.getString(key = action.prefKey, default = action.default.serialize())
        return com.ivansslo.terminal.ui.screens.terminal.ShortcutBinding.deserialize(raw)
    }

    fun setShortcutBinding(action: com.ivansslo.terminal.ui.screens.terminal.ShortcutAction, binding: com.ivansslo.terminal.ui.screens.terminal.ShortcutBinding) {
